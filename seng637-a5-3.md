...
- Reliability Growth Testing (RGT) and Reliability Demonstration Chart (RDC): 
    ...
    * Differences: 
        ...
        * RDC is mostly used when failure data is limited to a few failures, time of
failures are known, and one wants to find out what is the trend for reliability of the system
